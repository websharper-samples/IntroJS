...
{
 "use strict";
 var Global,Samples,HelloWorld,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Handler,IntroJS_Templates,Var,ConcreteVar,Snap,Collections,List,Unchecked,System,Guid,SC$1,Dictionary,HashSet,Client,Seq,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Object,View,AttrProxy,CheckedInput,Numeric,DictionaryUtil,Enumerator,T,EventTarget,Node,JS,DomUtility,SC$2,WindowOrWorkerGlobalScope,SC$3,Docs,SC$4,DocElemNode,CharacterData,Storage,Prepare,Slice,KeyCollection,An,Settings,Mailbox,HashSetUtil,Attrs,Dyn,Array,ArrayStorage,Elt,Strings,Docs$1,RunState,NodeSet,Anims,SC$5,List$1,T$1,Attrs$1,AttrModule,Updates,SC$6,Concurrency,AppendList,String,SC$7,Easing,AsyncBody,SC$8,CT,HashSet$1,Char,DynamicAttrNode,Scheduler,CancellationTokenSource,DomNodes,Queue,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,$,console,Math,Date;
 Global=self;
 ...
 IntroJS_Templates=Global.IntroJS_Templates=Global.IntroJS_Templates||{};
 Var=UI.Var=UI.Var||{};
 ...
 SC$1=Global.StartupCode$IntroJS$Client=Global.StartupCode$IntroJS$Client||{};
 ...
 {
  var newName,a,b,t,t$1,L,p,i;
  newName=Var$1.Create$1("");
  a=(b=(t=(t$1=(L=Doc.Convert(function(name)
  {
   var b$1,p$1,i$1;
   return(b$1=ProviderBuilder.Make().WithHole({
    ...
    $0:"name",
    $1:name
   }),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],IntroJS_Templates.listitem(p$1[0])),(b$1.i=i$1,i$1)))).get_Doc();
  },HelloWorld.People().v),ProviderBuilder.Make().WithHole({
   $:0,
   $0:"listcontainer",
   $1:L
  })).WithHole({
   ...
   $0:"name",
   $1:newName
  }),t$1.WithHole(Handler.EventQ2(t$1.k,"add",function()
  {
   return t$1.i;
  },function()
  {
   HelloWorld.People().Append(newName.Get());
   newName.Set("");
  }))),t.WithHole(Handler.EventQ2(t.k,"intro",function()
  {
   return t.i;
  },function()
  {
   (new Global.introJs()).start();
  }))),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],IntroJS_Templates.main(p[0])),(b.i=i,i)))).get_Doc();
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",a);
 };
 HelloWorld.People=function()
 {
  SC$1.$cctor();
  return SC$1.People;
 };
 ...
 IntroJS_Templates.listitem=function(h)
 {
 ...
 IntroJS_Templates.main=function(h)
 {
  return h?Templates.GetOrLoadTemplate("index",{
   $:1,
   $0:"main"
